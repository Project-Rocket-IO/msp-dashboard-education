...
pages_starter,
pages_profile,
pages_profile_with_pk,
pages_profile_settings,
pages_create_account,
pages_webview_delete_view,
pages_webview_create_view,
pages_team,
pages_timeline,
pages_help_center,
pages_pricing,
...
urlpatterns = [
    ...
    path("pages/profile/<int:pk>",view =pages_profile_with_pk,name="pages.profile_with_pk"),
    path("pages/profile-settings",view =pages_profile_settings,name="pages.profile_settings"),
    path("pages/profile-create-account",view=pages_create_account,name="pages.profile_create_account"),
    path("pages/profile/password/change", view=change_password_view, name="pages.profile.password.change"),
    path("pages/profile/password/set", view=set_password_view, name="pages.profile.password.set"),

    path("pages/profile-settings/webview-create/", view=pages_webview_create_view,name="pages.webview_create"),
    path("pages/profile-settings/webview-delete/<int:pk>", view=pages_webview_delete_view,name="pages.webview_delete"),
    path("pages/team",view =pages_team,name="pages.team"),
    path("pages/timeline",view =pages_timeline,name="pages.timeline"),
    path("pages/help-center",view =pages_help_center,name="pages.help_center"),
